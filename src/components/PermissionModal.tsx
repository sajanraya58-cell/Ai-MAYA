...
export default function PermissionModal({ onClose, assistantName = "Maya" }: Props) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-md p-4">
      ...
      >
        ...
        <p className="text-white/60 text-sm mb-6 leading-relaxed">
          Your browser has blocked microphone access for this site. {assistantName} cannot hear you until you allow it.
        </p>
